...
<map version="0.8.1">
  <node ID="b9aa22deba98b3b20c7ac8aca2" STYLE="bubble" TEXT="Agile Manifesto">
...
[agilemanifesto](https://agilemanifesto.org/)
    ...
    <node ID="243kq8hnan80l383tnv6autphs" POSITION="left" TEXT="🏆 Agile Indonesia">
      ...
      <node ID="7dp9kcptl4u0tnerpugckp26ku" TEXT="pattern">
        <node ID="02pgur9864n5mq76j4lbu9kunt" TEXT="agile indonesia"/>
      </node>
    </node>
  </node>
</map>
